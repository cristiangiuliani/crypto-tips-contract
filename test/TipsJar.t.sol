...
contract TipJarTest is Test {
    ...
    function test_SendTipSuccess() public {
        ...
        assertEq(
            ...
            "Owner should receive tip amount"
        );
        assertEq(
            tipJar.totalTipsCount(),
            1,
            "Tips count should increment"
        );
    }
    ...
    function test_GetBalanceIsZeroAfterTip() public {
        ...
        assertEq(
            tipJar.getBalance(),
            0,
            "Contract balance should be 0 after forwarding"
        );
    }
    ...
    function test_EmergencyWithdraw_OnlyOwner() public {
        ...
        assertEq(
            owner.balance,
            ownerBalanceBefore + 5 ether,
            "Owner should receive stuck ETH"
        );
        assertEq(
    ...
    function test_ReceiveETHDirectly() public {
        ...
        assertEq(
            ...
            "Owner should receive direct transfer"
        );
    }
    ...
    function testFuzz_SendTipWithRandomAmount(uint256 tipAmount) public {
        ...
        assertEq(
            owner.balance,
            ownerBalanceBefore + tipAmount,
            "Owner should receive exact tip amount"
        );
    }
